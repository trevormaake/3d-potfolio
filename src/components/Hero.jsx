  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} test-white`}>Hi, I'm 
          <span className="text-[#915eff]">Trevor</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I am a web <br className="sm:block hidden" />application developer 
          </p>
        </div>
